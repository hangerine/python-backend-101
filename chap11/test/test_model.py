...
def test_save_and_get_profile_picture(user_dao):
    ## Read 'profile_pic' first
    ## None is expected
    user_id = 1
    user_profile_picture = user_dao.get_profile_picture(user_id)
    assert user_profile_picture is None

    ## Save url of 'profile_pic'
    expected_profile_picture = "http://test_s3.amazonaws.com"
    ...
    assert actual_profile_picture == expected_profile_picture